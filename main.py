...
def main(in_file='/data',
    ...
    print("preprocess '/data/' to 'test.csv' file.")
    # in_file='/input/'
    ...
    print("answer_list的内容")
    print(answer_list)
    print("第三步evaluate执行结束")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--in_file', '-i',  default='/input/', help="data folder", required=False)
